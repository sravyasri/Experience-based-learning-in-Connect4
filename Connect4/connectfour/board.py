...
from TransformPlayer2 import newboard
...
#         print col
    ...
    def __isLinearMatch(self, x, y, stepX, stepY):
        ...
        for i in xrange(0, 4):
            cX = x + i * stepX
            cY = y + i * stepY
            if len(self._board) > cX and len(self._board[cX]) > cY and cX>=0 and cY>=0 and cX<6 and cY<7:
    ...
    def getRawScores(self):
        ...
        if c[1][4] >= 1:
            p1Score = 1000
            finalscore1= c[1][2] * 1 + c[1][3] * 4 + c[1][4] * 40 
            finalscore2= c[2][2] * 1 + c[2][3] * 4 + c[2][4] * 40
            finalscore=finalscore1-finalscore2
        else:
        ...
        return [0, p1Score, p2Score,finalscore]
    ...
    def getPossibleBoardPositions(self):
        possibleBoards=[]
#         print "cc"
#         print self._board
        for x in range(0,7):
...
#                     print "inif"
                    ...
                    newboard1._board[x][j]=2
#                     print(newboard1) 
#                     print "\n\n"

                    possibleBoards.append(newboard1)
#                     newboard1.print_()
#                     print newboard1.__str__()
                    break
                j=j+1;
